...
with Controller.from_port() as controller:
    ...
    # All hidden services have a directory on disk. Lets put ours in tor's data directory

    hidden_service_dir = os.path.join(controller.get_conf('DataDirectory', '/tmp'), 'hello_world')

    # Crate a hidden service where visitors of port 80 get redirected to local port 5000 (this is where flask runs by
    # default.
